...
4. **Active-Response Automation:** Developed a custom Bash script to parse JSON [Active-Resposne](./Active-Response) alert data and execute real-time threat remediation via automated file deletion.
...
<img width="1366" height="768" alt="Screenshot_2026-04-11_09_06_16" src="https://github.com/user-attachments/assets/58eb2928-9a6c-4490-a5b3-1ebb71f48bf9" />
